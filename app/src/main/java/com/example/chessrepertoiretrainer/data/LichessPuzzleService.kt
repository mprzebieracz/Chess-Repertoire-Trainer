...
object LichessPuzzleService {
     ...
     *
     * We store:
     *   - [Puzzle.fen]: FEN string when available (may come from puzzle, game, or the root object).
     *   - [Puzzle.moves]: the `puzzle.solution` array joined into a single space‑separated string
