...
interface SavedGameRepository {
    ...
    fun getAllGamesFiltered(platform: String?, result: String?, isWhite: Boolean?): Flow<List<SavedGame>>
    suspend fun getStats(username: String, platform: String, category: String?, isWhite: Boolean?, since: Long): GameStatsRaw
