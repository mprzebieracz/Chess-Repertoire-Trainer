...
import com.example.chessrepertoiretrainer.feature.stats.domain.OpeningStatsRow

/**
 * Default implementation of [com.example.chessrepertoiretrainer.feature.stats.domain.GameStatsRepository] backed by the existing
 * [com.example.chessrepertoiretrainer.feature.openingtree.domain.GamesRepository] and the [com.example.chessrepertoiretrainer.core.database.dao.GameStatsDao]. It computes per-game statistics
