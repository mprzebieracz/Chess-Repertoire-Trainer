...
@Composable
fun PuzzlesScreen(
    viewModel: PuzzlesViewModel, onStartTraining: () -> Unit
) {
    val uiState by viewModel.uiState.collectAsState()

    Scaffold(
        topBar = { TopAppBar(title = { Text("Puzzles") }) }) { innerPadding ->
        Box(
            modifier = Modifier
                .fillMaxSize()
            ...
            when {
                ...
                uiState.errorMessage != null -> {
                    ...
                    Column(
                        ...
                        Button(
                            onClick = onStartTraining, enabled = uiState.unsolvedCount > 0
                        ) {
