    ...
    Column(
        ...
        Column(
            ...
            if (uiState.hasNoLines) {
                Text(
                    text = "No lines in this chapter yet.",
                    style = MaterialTheme.typography.bodyMedium
                )
        ...
        when {
            ...
            uiState.phase == LearnPhase.CHAPTER_COMPLETE -> {
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .weight(1f),
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Button(
                                onClick = { onStartChapterTraining(uiState.chapterId) },
                ...
                Column(
                    ...
                    Row(
                        ...
                        OutlinedButton(
                            onClick = { viewModel.onPreviousMove() },
                            modifier = Modifier.weight(1f),
                        ...
                        OutlinedButton(
                            onClick = { viewModel.restartCurrentLine() },
                            modifier = Modifier.weight(1f)
                        ) {
                            Text("Restart")
                        }
                    ...
                    if (uiState.phase == LearnPhase.LINE_COMPLETE) {
                        Spacer(Modifier.height(8.dp))
                        Row(
                            modifier = Modifier.fillMaxWidth(),
                            horizontalArrangement = Arrangement.spacedBy(8.dp)
