...
@Composable
fun ChessScreenLayout(title: String,
    ...
    Column(modifier = layoutModifier,
        ...
        val boardPadding =
            Modifier.padding(horizontal = ChessUiConstants.ScreenChrome.BoardContainer.horizontalPadding,
        ...
        if (evaluationBarFraction != null) {
            ...
            BoxWithConstraints(modifier = boardPadding.fillMaxWidth()) {
                ...
                Row(modifier = Modifier
                    ...
                    EvaluationBar(fraction = evaluationBarFraction,
        ...
        if (showBoardActionButtons) {
            BoardActionButtons(onReset = { chessCtrl.resetBoard() },
...
fun ScreenHeader(title: String, endContent: @Composable RowScope.() -> Unit = {}) {
    Row(modifier = Modifier
        .fillMaxWidth()
        .padding(horizontal = ChessUiConstants.ScreenChrome.Header.horizontalPadding,
...
@Composable
fun PgnViewer(sanHistory: List<String>, currentMoveIndex: Int, onMoveClick: ((Int) -> Unit)?) {
    ...
    Card(modifier = Modifier
        .fillMaxWidth()
        .padding(horizontal = ChessUiConstants.ScreenChrome.Pgn.horizontalPadding,
            ...
            LazyRow(state = listState,
                ...
                itemsIndexed(sanHistory) { index, san ->
                    ...
                    Box(modifier = Modifier
                        ...
                        .background(if (isCurrent) MaterialTheme.colorScheme.primary
                                    else MaterialTheme.colorScheme.surface)
                        .then(if (onMoveClick != null) Modifier.clickable { onMoveClick(index) }
...
@Composable
fun BoardActionButtons(onReset: () -> Unit,
                       onFlip: () -> Unit,
                       extraButtons: @Composable RowScope.() -> Unit) {
    Row(modifier = Modifier
        .fillMaxWidth()
...
@Composable
fun BoardBottomBar(chessCtrl: ChessBoardController,
                   extraButtons: @Composable RowScope.() -> Unit = {}) {
    Column {
        BoardNavigationControls(onBack = { chessCtrl.navigateBack() },
                                onForward = { chessCtrl.navigateForward() })
