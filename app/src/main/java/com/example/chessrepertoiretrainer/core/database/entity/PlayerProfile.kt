...
data class PlayerProfile(
    @PrimaryKey(autoGenerate = true) val id: Long = 0, val username: String, val platform: String, // e.g. "lichess" or "chess.com"
    val displayName: String? = null, val lastSyncTime: Long? = null
)
