...
fun NavGraphBuilder.myGamesGraph(navController: NavHostController, appContainer: AppContainer) {
    composable(Screen.MyGames.route) {
        val vm: MyGamesViewModel =
            viewModel(factory = MyGamesViewModel.Factory(syncManager = appContainer.gameSyncManager,
    ...
    composable(route = Screen.AccountStats.route,
        ...
        val vm: AccountStatsViewModel =
            viewModel(factory = AccountStatsViewModel.Factory(platform = platform,
                                                              username = username,
    ...
    composable(route = Screen.GameDetail.route,
